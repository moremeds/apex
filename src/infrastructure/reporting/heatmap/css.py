"""
Heatmap CSS Theme - Professional Dark Trading Dashboard.

This module contains the shared CSS for both:
- index.html (heatmap/treemap visualization)
- report.html (signal analysis report)

All styles are scoped under .apex-hm to prevent global CSS bleed.

Usage:
    from src.infrastructure.reporting.heatmap.css import HEATMAP_CSS
...
# =============================================================================
# HEATMAP_CSS - Professional Dark Trading Theme
# =============================================================================
