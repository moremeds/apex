...
def create_argument_parser() -> argparse.ArgumentParser:
    ...
    full.add_argument("--universe", type=str, default="config/validation/regime_universe.yaml")
    ...
    holdout.add_argument("--universe", type=str, default="config/validation/regime_universe.yaml")
    ...
    optimize.add_argument("--universe", type=str, default="config/validation/regime_universe.yaml")
