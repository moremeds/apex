...
PATTERN_RULES = [
    ...
    # =========================================================================
    # Chart Patterns Rules
    # =========================================================================
    # Reversal Patterns - Bearish
    SignalRule(
        name="chart_pattern_double_top",
        indicator="chart_patterns",
        category=SignalCategory.PATTERN,
        direction=SignalDirection.SELL,
        strength=75,
        priority=SignalPriority.HIGH,
        ...
        timeframes=("1h", "4h", "1d"),
        cooldown_seconds=14400,
        message_template="{symbol} Double Top pattern detected (bearish reversal)",
    ),
    SignalRule(
        name="chart_pattern_head_shoulders",
        indicator="chart_patterns",
        category=SignalCategory.PATTERN,
        direction=SignalDirection.SELL,
        strength=80,
        ...
        condition_config={
            "field": "pattern",
            "from": [None],
            "to": ["head_and_shoulders"],
        },
        timeframes=("1h", "4h", "1d"),
        cooldown_seconds=14400,
        message_template="{symbol} Head & Shoulders pattern detected (bearish reversal)",
    ),
    # Reversal Patterns - Bullish
    SignalRule(
        name="chart_pattern_double_bottom",
        indicator="chart_patterns",
        category=SignalCategory.PATTERN,
        direction=SignalDirection.BUY,
        strength=75,
        ...
        timeframes=("1h", "4h", "1d"),
        cooldown_seconds=14400,
        message_template="{symbol} Double Bottom pattern detected (bullish reversal)",
    ),
    SignalRule(
        name="chart_pattern_inv_head_shoulders",
        indicator="chart_patterns",
        category=SignalCategory.PATTERN,
        direction=SignalDirection.BUY,
        strength=80,
        ...
        condition_config={
            "field": "pattern",
            "from": [None],
            "to": ["inverse_head_and_shoulders"],
        },
        timeframes=("1h", "4h", "1d"),
        cooldown_seconds=14400,
        message_template="{symbol} Inverse Head & Shoulders pattern detected (bullish reversal)",
    ),
    # Continuation Patterns - Triangles
    SignalRule(
        name="chart_pattern_ascending_triangle",
        indicator="chart_patterns",
        category=SignalCategory.PATTERN,
        direction=SignalDirection.BUY,
        strength=65,
        ...
        condition_config={
            "field": "pattern",
            "from": [None],
            "to": ["ascending_triangle"],
        },
        timeframes=("1h", "4h", "1d"),
        cooldown_seconds=14400,
        message_template="{symbol} Ascending Triangle pattern (bullish continuation)",
    ),
    SignalRule(
        name="chart_pattern_descending_triangle",
        indicator="chart_patterns",
        category=SignalCategory.PATTERN,
        direction=SignalDirection.SELL,
        strength=65,
        ...
        condition_config={
            "field": "pattern",
            "from": [None],
            "to": ["descending_triangle"],
        },
        timeframes=("1h", "4h", "1d"),
        cooldown_seconds=14400,
        message_template="{symbol} Descending Triangle pattern (bearish continuation)",
    ),
    SignalRule(
        name="chart_pattern_symmetrical_triangle",
        indicator="chart_patterns",
        category=SignalCategory.PATTERN,
        direction=SignalDirection.ALERT,
        strength=60,
        ...
        condition_config={
            "field": "pattern",
            "from": [None],
            "to": ["symmetrical_triangle"],
        },
        timeframes=("1h", "4h", "1d"),
        cooldown_seconds=14400,
        message_template="{symbol} Symmetrical Triangle pattern (breakout imminent)",
    ),
    # Generic direction change rules (catches any pattern with direction change)
    SignalRule(
        name="chart_pattern_bullish_detected",
        indicator="chart_patterns",
        category=SignalCategory.PATTERN,
        direction=SignalDirection.BUY,
        strength=70,
        ...
        timeframes=("1h", "4h", "1d"),
        cooldown_seconds=7200,
        message_template="{symbol} bullish chart pattern forming",
    ),
    SignalRule(
        name="chart_pattern_bearish_detected",
        indicator="chart_patterns",
        category=SignalCategory.PATTERN,
        direction=SignalDirection.SELL,
        strength=70,
        ...
        timeframes=("1h", "4h", "1d"),
        cooldown_seconds=7200,
        message_template="{symbol} bearish chart pattern forming",
    ),
]
