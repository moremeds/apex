...
VOLUME_RULES = [
    ...
    # =========================================================================
    # AD (Accumulation/Distribution) Rules
    # =========================================================================
    SignalRule(
        name="ad_accumulation",
        indicator="ad",
        category=SignalCategory.VOLUME,
        direction=SignalDirection.BUY,
        strength=55,
        ...
        timeframes=("1h", "4h", "1d"),
        cooldown_seconds=7200,
        message_template="{symbol} A/D Line turned to accumulation (buying pressure)",
    ),
    SignalRule(
        ...
        timeframes=("1h", "4h", "1d"),
        cooldown_seconds=7200,
        message_template="{symbol} A/D Line turned to distribution (selling pressure)",
    ),
    # =========================================================================
    # Volume Ratio Rules
    # =========================================================================
    SignalRule(
        name="volume_ratio_spike",
        ...
        timeframes=("1h", "4h", "1d"),
        cooldown_seconds=3600,
        message_template="{symbol} Volume ratio spike detected - unusual activity",
    ),
    SignalRule(
        name="volume_ratio_high",
        indicator="volume_ratio",
        category=SignalCategory.VOLUME,
        direction=SignalDirection.ALERT,
        strength=65,
        ...
        timeframes=("1h", "4h", "1d"),
        cooldown_seconds=7200,
        message_template="{symbol} Volume ratio turned high - significant volume increase",
    ),
    SignalRule(
        name="volume_ratio_low",
        indicator="volume_ratio",
        category=SignalCategory.VOLUME,
        direction=SignalDirection.ALERT,
        strength=50,
        ...
        timeframes=("1h", "4h", "1d"),
        cooldown_seconds=14400,
        message_template="{symbol} Volume ratio turned low - lack of interest",
    ),
]
