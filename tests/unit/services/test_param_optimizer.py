...
class TestObjectiveFunctions:
    ...
    def test_regime_stability_objective(self, sample_ohlcv: Any, sample_regime_series: Any) -> None:
    ...
    def test_regime_stability_high_transitions(self) -> None:
    ...
    def test_trading_proxy_objective(self, sample_ohlcv: Any, sample_regime_series: Any) -> None:
    ...
    def test_trading_proxy_insufficient_data(self) -> None:
    ...
    def test_turning_point_quality_no_experiment(self) -> None:
...
class TestObjectiveEvaluator:
    ...
    def test_evaluator_default_objectives(
        self, sample_ohlcv: Any, sample_regime_series: Any
    ) -> None:
    ...
    def test_evaluator_custom_objectives(
        self, sample_ohlcv: Any, sample_regime_series: Any
    ) -> None:
    ...
    def test_objective_summary(self) -> None:
...
class TestWalkForwardOptimizer:
    ...
    def test_generate_folds(self, sample_ohlcv: Any) -> None:
    ...
    def test_fold_no_overlap_property(self, sample_ohlcv: Any) -> None:
    ...
    def test_embargo_property(self, sample_ohlcv: Any) -> None:
    ...
    def test_optimize_insufficient_data(self) -> None:
    ...
    def test_param_stability_calculation(self) -> None:
...
class TestParamStability:
    ...
    def test_stability_all_positive(self) -> None:
    ...
    def test_stability_mixed_directions(self) -> None:
