...
The TUI displays real-time risk metrics with 5 different views.

### Account Summary View (Key: 1)

```
┌─────────────────────────────────────────────────────────────────┐
│ APEX │ dev │ [1]Account [2]Signals [3]IB [4]Futu [5]Lab │ IB:●  │
├─────────────────────────────────────────────────────────────────┤
│ Portfolio Summary                                               │
...
│   Gross Notional: $2.5M / $5M (50%)                            │
│   Top Underlying: TSLA 28% │ SPY 15% │ AAPL 12%                │
├─────────────────────────────────────────────────────────────────┤
│ Health                                                          │
│   IB: Connected │ Futu: Disconnected │ MD Quality: 98%         │
└─────────────────────────────────────────────────────────────────┘
```

### Positions View (Key: 3 or 4)

```
┌─────────────────────────────────────────────────────────────────┐
│ IB Positions │ ATR: 14 │ Timeframe: Daily │ [h] Help           │
├─────────────────────────────────────────────────────────────────┤
│ Symbol  Qty    Mark     P&L       Delta  Gamma   DTE           │
│ ► TSLA  100   $245.50  +$1,234    100    0.00    -             │
│   AAPL  200   $178.30  +$567      200    0.00    -             │
│   SPY   -50   $450.00  -$234     -50     0.00    -             │
├─────────────────────────────────────────────────────────────────┤
│ ATR Levels: TSLA @ $245.50                                      │
│   +3 ATR: $268.20  │  +2 ATR: $260.80  │  +1 ATR: $253.15      │
│   -1 ATR: $237.85  │  -2 ATR: $230.20  │  -3 ATR: $222.80      │
└─────────────────────────────────────────────────────────────────┘
```
...
```
┌─────────────────────────────────────────────────────────────────┐
│ Strategy Lab │ Backtest Workspace                               │
├─────────────────────────────────────────────────────────────────┤
│ Available Strategies:                                           │
│   [1] ma_cross      │ Moving Average Crossover                  │
│   [2] buy_and_hold  │ Passive Benchmark                         │
│   [3] rsi_reversion │ RSI Mean Reversion                        │
├─────────────────────────────────────────────────────────────────┤
│ Last Backtest: ma_cross on AAPL                                │
│   Return: +8.45%  │  Sharpe: 1.45  │  Max DD: -5.2%            │
└─────────────────────────────────────────────────────────────────┘
```
...
|------|-----|-------------|
| Account Summary | `1` | Portfolio P&L, Greeks, concentration |
| Risk Signals | `2` | Active soft/hard breach alerts |
| IB Positions | `3` | Interactive Brokers positions grid |
| Futu Positions | `4` | Futu positions grid |
| Lab | `5` | Strategy backtesting workspace |
...
| Key | Action |
|-----|--------|
| `1-5` | Switch dashboard view |
| `q` | Quit |
| `Ctrl+C` | Graceful shutdown |

**Position Views (IB/Futu):**
| Key | Action |
|-----|--------|
| `Up/Down` | Navigate position list |
